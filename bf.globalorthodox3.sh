...
#                    | function
# 2.0 |REN|08/08/2022| Switched to bfunc and to Orthodox
...
if [[ -z "${__globalorthodox}" ]] ; then
	...
	################################################################
#	__Flavor=$(bfunc_idlike)
#	__OS=$(bfunc_os)
#	__Version=$(bfunc_os_version_id)
#	__Arch=$(bfunc_arch)
	__FOVA="$(bfunc_idlike)_$(bfunc_os)_$(bfunc_os_version_id)"
	__FOVA="${__FOVA}_$(bfunc_arch)"
