...
#TESTNAME00="Test of function (bf.bashseedrandom) from"
...
########################################################################	
# The randomint is number generate by the random number
...
#			"\$(bf_bashseedrandom \${tvs[${ti}]} ) should " \
#			"be '' - the NULL String"
#	fi
...
########################################################################
	...
	################################################################	
	RANDOM=${tvs[${ti}]}
#	if [[ ! "$(bf_bashseedrandom ${tvs[${ti}]} )" == "" ]]; then
#		((fail++))
#	fi
	...
	do
		...
		########################################################	
		randomint="$(bf_bashrandomrange ${lower} ${upper} )"
